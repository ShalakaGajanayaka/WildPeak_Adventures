 ...
 * @author USER
 */
public class StockManagerSignIn extends javax.swing.JFrame {

    /**
     * Creates new form superAdminSignIn
     */
    public StockManagerSignIn() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("STOCK MANAGER SIGN IN");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockManagerSignIn().setVisible(true);
            }
        });
    }
