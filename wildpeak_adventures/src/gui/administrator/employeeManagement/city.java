...
public class city extends javax.swing.JDialog {
    ...
    public city(JDialog  parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadcity();
    ...
    private void loadcity() {
        ...
        try {
            ...
            ResultSet resultSet = MYSQL.executeSearch("SELECT * FROM `city` INNER JOIN `district` ON `district`.`id` = `city`.`district_id`");
...
//            logger.log(Level.WARNING, "Exception In Address View in loadCities", e);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (city.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please enter City", "Information", JOptionPane.INFORMATION_MESSAGE);
                ...
                if (resultSet.next()) {
                    JOptionPane.showMessageDialog(this, "This City is Already Added.", "Information", JOptionPane.INFORMATION_MESSAGE);
                    return; // Exit the method if an address already exists
                } else {
                    MYSQL.executeIUD("INSERT INTO `city`(`name`,`district_id`)"
                            + "VALUES('" + city + "','" + DistrictMap.get(district) + "')");
