 ...
 * @author shalaka
 */
public class EditRoomFacilites extends javax.swing.JDialog {
     ...
     */
    public EditRoomFacilites(RoomFacilitesList parent, boolean modal) {
//        super(parent, modal);
        this.parent = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Room Facilites");
...
//            Notifications.getInstance().show(Notifications.Type.ERROR, Notifications.Location.TOP_CENTER, "An error occurred while adding the facility.");
            ...
            Logger.getLogger(EditRoomFacilites.class.getName()).log(Level.SEVERE, null, ex);
        }
